...
- **Additional for Fairwave/SIM projects:**
  - No doxxing of network operators, users, or IMSI/P Identities.
  - No requests for lawful-interception bypass, IMSI catching, or spectrum misuse help.
  - When discussing security vulnerabilities, follow [SECURITY.md](SECURITY.md) responsible disclosure.
...
individual is officially representing the community in public spaces (e.g., conferences,
mailing lists, social media).

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported
to the community leaders responsible for enforcement at conduct@hyperonx.io. All
